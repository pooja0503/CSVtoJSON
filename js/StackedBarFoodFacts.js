var margin={top:20, bottom:100, left:150, right:50},
  ...
  height=700-margin.top-margin.bottom;  var horizontal=d3.scale.ordinal().rangeRoundBands([0,width],0.25),
...
d3.json("../NodeJS/countryConsumption.json",function(err,data){
data.forEach(function(d){
  d.Country=d.Country;
  d.SugarConsumption=+d.SugarConsumption;
  d.SaltConsumption=+d.SaltConsumption;
});
var xData=["SugarConsumption","SaltConsumption"];
...
var layer = svg.selectAll(".stack")
  ...
  .append("text")
     ...
     .style("font-weight","bold")
     .style("color","red")
     .text("Sugar And Salt Consumption");       var legend = svg.selectAll(".legend")
